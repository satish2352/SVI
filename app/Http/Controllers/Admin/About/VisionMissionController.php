...
use App\Http\Services\Admin\About\VisionMissionServices;
use Session;
use Validator;
use Config;
    ...
    public function __construct(){
        ...
        public function index(){
            try {
                ...
                return view('admin.pages.about.vision-mission.list-vision-mission', compact('getOutput'));
            } catch (\Exception $e) {
                return $e;
            }
        }    
        public function add(){
            return view('admin.pages.about.vision-mission.add-vision-mission');
        }
        public function store(Request $request){
            $rules = [
                'vision_description' => 'required',
                'mission_description' => 'required',
                'vision_image' => 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.VISION_MISSION_IMAGE_MAX_SIZE").'|dimensions:min_width=300,min_height=300,max_width=1000,max_height=1000|min:'.Config::get("AllFileValidation.VISION_MISSION_IMAGE_MIN_SIZE").'',
                'mission_image' => 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.VISION_MISSION_IMAGE_MAX_SIZE").'|dimensions:min_width=300,min_height=300,max_width=1000,max_height=1000|min:'.Config::get("AllFileValidation.VISION_MISSION_IMAGE_MIN_SIZE").'',
        ...
        public function show(Request $request){
            try {
                ...
                return view('admin.pages.about.vision-mission.show-vision-mission', compact('showData'));
            } catch (\Exception $e) {
                return $e;
            }
        }
        public function edit(Request $request){
            ...
            return view('admin.pages.about.vision-mission.edit-vision-mission', compact('editData'));
        }
        public function update(Request $request){
            ...
            if($request->has('vision_image')) {
                $rules['vision_image'] = 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.VISION_MISSION_IMAGE_MAX_SIZE").'|dimensions:min_width=300,min_height=300,max_width=1000,max_height=1000|min:'.Config::get("AllFileValidation.VISION_MISSION_IMAGE_MIN_SIZE");
            }
            if($request->has('mission_image')) {
                $rules['mission_image'] = 'required|image|mimes:jpeg,png,jpg|max:'.Config::get("AllFileValidation.VISION_MISSION_IMAGE_MAX_SIZE").'|dimensions:min_width=300,min_height=300,max_width=1000,max_height=1000|min:'.Config::get("AllFileValidation.VISION_MISSION_IMAGE_MIN_SIZE");
            }
