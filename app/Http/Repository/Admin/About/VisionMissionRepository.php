<?php
namespace App\Http\Repository\Admin\About;
    ...
    public function getAll(){
     ...
     public function addAll($request){
        try {
            ...
            $slide = VisionMission::find($last_insert_id); // Assuming $request directly contains the ID
            $slide->vision_image = $visionImageName; // Save the image filename to the database
            $slide->mission_image = $missionImageName; // Save the image filename to the database
            $slide->save();
