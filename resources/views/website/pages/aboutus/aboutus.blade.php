...
<section class="certificateSection pt-5">
  ...
  <h4 class="text-center bg-white p-0 m-0 HomeAbout heading">
    ...
    <div class="row">
      <img src="{{ asset('website/assets/images/aboutus/certificate.png')}}" class="mx-auto d-none d-md-block d-lg-block certificate"
        alt="certificate" />
      <img src="{{ asset('website/assets/images/aboutus/MobCertificate.jpg')}}" class="mx-auto my-3 d-block d-md-none d-lg-none certificate"
        alt="certificate" />
    </div>
  </div>
</section>
