         ...
         <div class="container-fluid">
           ...
           <div class="row">
               <div class="col-lg-4 col-md-4 col-sm-4">
                 <div class="card">
                 <img src="./Assets/product/1.png" alt="Home_Banner" class="img-fluid" />
               ...
               <div class="col-lg-4 col-md-4 col-sm-4">
                 <div class="card">
                 <img src="./Assets/product/2.png" alt="Home_Banner" class="img-fluid" />
               ...
               <div class="col-lg-4 col-md-4 col-sm-4">
                 <div class="card">
                 <img src="./Assets/product/3.png" alt="Home_Banner" class="img-fluid" />
