    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
          <div class="col-lg-4 col-md-4 col-8">
            ...
            <img src="./Assets/services/1.png" alt="Home_Banner" class="img-fluid" />
          </div>

          <div class="col-lg-4 col-md-4 col-8">
           
            <img src="./Assets/services/2.png" alt="Home_Banner" class="img-fluid" />
          ...
          <div class="col-lg-4 col-md-4 col-8">
            ...
            <img src="./Assets/services/3.png" alt="Home_Banner" class="img-fluid" />          
          </div>
      </div>
    </div>
   </section>
